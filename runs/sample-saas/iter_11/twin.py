...
class Twin:
    ...
    def fit(self, obs):
        # obs.time_s is in hours (720h = 1 month) – but we convert to months directly
        ...
        def objective(log_params):
            ...
            # Convert hours to seconds for predict
            time_s_full = obs.time_s * 3600.0
            pred = self.predict(params, time_s_full, exog)
            
            err = 0.0
            # Weight mrr and customers heavily; cash also important
        ...
        # Use values that roughly match the observed data
